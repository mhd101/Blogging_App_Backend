...
app.use(cors({ credentials: true, origin: 'https://dailydevdot.netlify.app/' }))
...
const url = `mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@mern-blog.kbcmcaj.mongodb.net/?retryWrites=true&w=majority`
